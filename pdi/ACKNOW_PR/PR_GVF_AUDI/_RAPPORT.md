# Rapport de conversion : PR_GVF_AUDI

Source : `PR_GVF_AUDI.dtsx`

## Fichiers PDI generes

- `PR_GVF_AUDI_AUDI.ktr`
- `PR_GVF_AUDI_SEAT.ktr`
- `PR_GVF_AUDI_SKODA.ktr`
- `PR_GVF_AUDI.kjb`

## Composants du package

- **AUDI** — `Microsoft.Pipeline`
- **Copie du fichier à intégrer dans le répertoire attendu par I'COM AUDI** — `Microsoft.FileSystemTask`
...
- **Suppression du fichier Acknow PR Initial AUDI** — `Microsoft.FileSystemTask`
...
- **Test présence du fichier AUDI** — `Microsoft.ScriptTask`
